<?php
	...
	*/
	...
	define('INDUSTRY_TYPE_ID', 'Retail'); //Change this constant's value with Website industry type received from Paytm.
	define('CHANNEL_ID', 'WEB'); //Change this constant's value with Website channel id received from Paytm.
	define('CALLBACK_URL', 'http://localhost/hotelbooking/pay_response.php'); //Change this constant's value with callback url received from Paytm.
