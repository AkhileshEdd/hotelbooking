           ...
           <!-- General Settings Section-->
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        No customers will be allowed to book hotel room , when shutdown mode is tutned on.
                    </p>               
                </div>
            </div>
...
<script>
    ...
    let grneral_s_form =document.getElementById('grneral_s_form');
