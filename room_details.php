                ...
                <div class="carousel-inner">
                    <?php 
                       // get thumbnail of image
                        ...
                        $img_q = mysqli_query($conn,"SELECT * FROM `rooms_images` WHERE `room_id`='$room_data[id]'");
                        if(mysqli_num_rows($img_q)>0){
                            $active_class = 'active';
                           while($img_res = mysqli_fetch_assoc($img_q)){
                            echo "<div class='carousel-item $active_class'>
                            <img src='".ROOMS_IMG_PATH.$img_res['image']."' class='d-block w-100 rounded-3'>
                            </div>";
                           }
                           $active_class = '';
                        }
